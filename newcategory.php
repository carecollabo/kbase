    ...
    <body>
        ...
        <div class="container">   
            <div class="container" style="margin-top:10px;">
                <p class="fontsforweb_fontid_494">Add <strong>Category</strong></p><!--..............IT'S A BEAUTIFUL HEADER TADIWA.......-->
...
<strong>Success!</strong> Your message has been sent successfully.
            ...
            if(isset($_POST['btnCreate'])){
                ...
                $shotname = trim($_POST['shortname']);
                $trimdname = preg_replace('/\s+/', '', $catname);

                if (!empty($catname)) {
                    $sql="INSERT INTO upload_category(category,description) VALUES ('".$trimdname."','".$shotname."')";
                    $rst = $mysqli->query($sql);
                    if($rst){
                        echo ('<div class="alert alert-success fade in">');
                        echo ('<a href="" class="close" data-dismiss="alert">&times;</a>');
                        echo ('<strong>Success!</strong> Upload category added successfully.');
                        echo ('</div>');
                    }else{
                    ...
                    echo ('<a href="" class="close" data-dismiss="alert">&times;</a>');
                    echo ('<strong>Error!</strong> Upload category creation failed (try again).');
                    echo ('</div>');
                }
            }    
            ?>                              
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;&nbsp;New category</a>
                        </h4>
                    </div>
                        ...
                        <div class="panel-body">
                            <form action="" method="post">
                                <table id="allprods" class="table table-condensed table-hover" style="font-size:15px;">
                                    <tr>
                                        <td>Category name</td>
                                        <td><input type="text" class="form-control" name="catname" placeholder="category" required></td>
                                    </tr>
                                    <tr>
                                        <td>Description</td>
                                        <td><input type="text" class="form-control"  name="shortname" placeholder="description" required></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <center style="margin-top:8px;">
                                                <a href="viewcategories.php">All categories</a>
                                            </center>
                                        </td>
                                        <td>
                                            <button type="submit" name="btnCreate" class="btn btn-primary btn-block">Save Category</button>
                                        </td>
                                    </tr>
                                </table>
                            </form>
