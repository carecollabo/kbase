    ...
    <body>
        ...
        <div class="container">  
            <div class="container" style="margin-top:10px;">
                <p class="fontsforweb_fontid_494">Create <strong>Post</strong></p>
            ...
            if (isset($_POST["btn-post"])){
                ...
                $newpost  = trim($_POST['newpost']);
                    ...
                    $sql="INSERT INTO post (title,content,post_category,view_level,post_by,post_date) VALUES ('".$title."','".$newpost."','".$category."','".$proj."','".$username."',now())";
                    $result=mysqli_query($cstring,$sql);
                    if ($result) {
                        echo ('<div class="alert alert-success fade in">');
                        echo ('<a href="" class="close" data-dismiss="alert">&times;</a>');
                        echo ('<strong>Success!</strong> Post successful.');
                        echo ('</div>');
                    }else{
                        echo ('<div class="alert alert-danger fade in">');
                        echo ('<a href="" class="close" data-dismiss="alert">&times;</a>');
                        echo ('<strong>Error!</strong> Post failed.'.mysqli_error($cstring));
                        echo ('</div>');
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;&nbsp;New Material</a>
                        </h4>
                    </div>
                                ...
                                <center>
                                    <table class="table table-condensed table-hover" style="font-size:15px;">
                                        ...
                                        <tr>
                                            <td>Post:</td>
                                            <td>
                                                <textarea name="newpost" class="form-control" cols="19" rows="4" required></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <center style="margin-top:8px;">
                                                    <a href="viewpost.php">Other Materials</a>
                                                </center>
                                                <?php }else{?>
                                                <center style="margin-top:8px;">
