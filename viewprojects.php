    ...
    <body>
        ...
        <div class="container">  
            <div class="container" style="margin-top:10px;">
                <p class="fontsforweb_fontid_494">Projects <strong>List</strong></p>
                            ...
                            <form action="" method="post">
                                ...
                                <table id="allcats" class="table table-condensed table-hover table-bordered table-striped" style="font-size:12px;">
                                    ...
                                    <tbody class="list">                       
                                        ...
                                        $results = $mysqli->query("SELECT project_name,description FROM project");
                                        while ( $db_field = $results->fetch_assoc() ) {
                                            $categor = $db_field['project_name'];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
<a title="Edit Project" class="btn glyphicon glyphicon-pencil" style="font-size:12px;" href="editproject.php?projectname=<?php echo $categor; ?>">&nbsp;Edit</a>
                                                </center>
                                            </td>
                                            <td>
                                                <center>
<a title="Delete Project" class="btn glyphicon glyphicon-trash" style="color:red;font-size:12px;" href="deleteproject.php?projectname=<?php echo $categor; ?>">&nbsp;Delete</a>
                                                </center>
                                            </td>
                                        </tr><?php }?></tbody>
                                </table>
